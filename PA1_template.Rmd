...
**Solution:** The mean and median total number of steps taken per day are `r ma` and `r mm`, respectively.
...
**Solution:** `r max$interval` interval contains the maximum number of steps on averge across all the days, which is `r max$steps`.
